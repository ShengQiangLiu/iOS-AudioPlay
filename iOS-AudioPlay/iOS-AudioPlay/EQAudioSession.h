...
FOUNDATION_EXPORT NSString *const EQAudioSessionRouteChangeNotification;
 ...
 */
FOUNDATION_EXPORT NSString *const EQAudioSessionRouteChangeReason;

/* interrupt notification */
FOUNDATION_EXPORT NSString *const EQAudioSessionInterruptionNotification;
/* a NSNumber of kAudioSessionBeginInterruption or kAudioSessionEndInterruption */
FOUNDATION_EXPORT NSString *const EQAudioSessionInterruptionStateKey;
/* Only present for kAudioSessionEndInterruption. a NSNumber of AudioSessionInterruptionType.*/
FOUNDATION_EXPORT NSString *const EQAudioSessionInterruptionTypeKey;



@interface EQAudioSession : NSObject
